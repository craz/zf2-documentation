...
(шлюз к  данным таблицы) может стать проблемой в больших системах. Существует также искушение использовать код
доступа к базе данных в действии контроллера, поскольку это открывает методы
